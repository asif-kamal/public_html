                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <h2 class="btn btn-primary btn-block" id="LoopBtn" href="#correctMonitor">
                                        Loop Order Correctness Investigation
                                    </h2>
                                    <div id="LoopRun" class="container mt-5">
                                    <div class="row">
                                            <div class="col">
                                        <form>
                                            Size(3-20):
                                        ...
                                        <div class="row mt-3">
                                            <div class="col">
                                            <h5>Results:</h5>
                                                <div id="results6_2a" class="card-body">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="container mt-5" id="Results">
                                        <div class="row">
                                            <div class="col">
                                                <form>
                                                    <div class="mb-3">
                                                        <label for="input1" class="form-label">Size(100-1100)</label>
                                                        <input type="number" class="form-control" value="0" min="100"
                                                            max="1100" id="input1" name="nSize" placeholder="Enter input 1">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="input2" class="form-label">Repetitions(2-5)</label>
                                                        <input type="number" class="form-control" value="0" min="2"
                                                            max="5" id="input2" name="nRepetitions" placeholder="Enter input 2">
                                                    </div>
                                                    <button type="submit" id="lab6_2b" class="btn btn-primary">Run</button>
                                                </form>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
